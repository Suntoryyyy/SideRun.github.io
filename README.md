...
- 🌤️ **Smart Prompts:** The user receives a daily weather push notification with a smart suggestion for the best time to run today.
...
- 🖼️ **Rich Visual Summaries:** SideRun generates a variety of aesthetically pleasing, data-rich post-run summary cards. 
...
### 🛠️ 4.3 Improvements Implemented
...
### ⚖️ 5.1 The Biggest Challenge: The Art of Trade-offs
...
In accordance with modern development practices, this section documents the use of Artificial Intelligence tools during the development of SideRun.
...
- **Prompts used:** 
  ...
  - *Documentation prompts:* We used AI to structure this Process Portfolio, translate our thoughts into professional English, and refine the phrasing.
...
- **Ethical considerations:** 
  ...
  - *Integrity:* We are transparently declaring our use of AI in this section. We used AI to enhance our productivity and the quality of our final deliverable, while maintaining full ownership of the creative process.
...
### 🎯 Project Context
SideRun is a live, interactive Web/Mobile App designed to make running a more connected and playful experience.
